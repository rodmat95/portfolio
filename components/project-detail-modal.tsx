...
export default function ProjectDetailModal({ project, onClose }: ProjectDetailModalProps) {
  ...
  return (
    <AnimatePresence>
      {project && (
        <motion.div
          className="fixed inset-0 z-[70] overflow-y-auto bg-background/80 backdrop-blur-sm"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          exit={{ opacity: 0 }}
        >
          <div className="min-h-full flex items-center justify-center p-4 py-12 pointer-events-none">
            <motion.div
              ref={modalRef}
              className="bg-background border rounded-lg shadow-xl w-full max-w-4xl pointer-events-auto"

...
function App() {
  return (
    <main className="max-w-[374px] sm:max-w-[629px] md:max-w-[759px] lg:max-w-[1014px] xl:max-w-[1269px] mx-auto flex flex-col xl:flex-row items-center xl:items-start gap-4 sm:gap-6 pt-4 pb-16 px-4 sm:py-16">

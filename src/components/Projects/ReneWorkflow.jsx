...
const ReneWorkflow = ({ show, onClose }) => {
  if (!show) return null;
  ...
  return (
    ...
    >
      ...
      >
        ...
        <h3 className="text-xl sm:text-2xl font-bold">ReneWorkflow</h3>
        <h4 className="text-sm sm:text-base font-semibold">
          Sistema de gestión de citas y requerimientos.
        </h4>
